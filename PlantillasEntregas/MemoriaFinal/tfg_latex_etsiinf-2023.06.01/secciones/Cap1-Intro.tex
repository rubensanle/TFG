...
\begin{enumerate}
    ...
    En este capítulo, se describen cada uno de los modelos de aprendizaje automático implementados para afrontar el problema de predicción de series temporales financieras. Primero de todo, se presentan los modelos de Machine Learning que serán usados en el proyecto, dichos modelos son Random Forest, Gradient Boosting y LightGBM. A continuación, se introduce el modelo de Deep Learning basado en redes neuronales recurrentes del tipo LSTM, describiendo su arquitectura, su capacidad para identificar dependencias temporales en los datos y las técnicas de regularización empleadas (data augmentation y Gaussian noise) para mitigar el sobreajuste debido al reducido tamaño del dataset. A continuación, se explica el proceso de entrenamiento de los modelos, detallando la división de los datos en conjuntos de entrenamiento, validación y prueba, la configuración de hiperparámetros mediante búsqueda en rejilla con validación cruzada temporal, y las curvas de evolución de la pérdida durante el entrenamiento. Finalmente, se presentan los resultados obtenidos por cada modelo en el conjunto de prueba, la evaluación mediante backtesting con ventana deslizante para analizar la robustez temporal de los modelos, y una comparativa global entre todos ellos, viendo asi que aporta cada modelo a la prediccón.

    \item \textbf{Capítulo 5: Experimentos y resultados}
    En este capítulo se presentan experimentos adicionales para profundizar en el análisis de los modelos. En primer lugar, se aplican técnicas de interpretabilidad como SHAP y LIME, con el objetivo de analizar la importancia de las variables y comprender mejor las predicciones generadas por los modelos. A continuación, se realizan distintos experimentos donde se estudia el impacto de la incorporación de variables macroeconómicas, comparando resultados obtenidos con y sin estas variables. También se someten los modelos a distintos escenarios, como simulaciones con variables macroeconómicas dinámicas o estáticas, y escenarios hipotéticos que permiten estudiar el comportamiento del sistema ante posibles cambios en las condiciones del mercado. Finalmente, se presentan las conclusiones del capítulo.
